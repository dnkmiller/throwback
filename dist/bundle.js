...
var Game = function (_Phaser$Game) {
  ...
  function Game() {
    ...
    _this.state.add('NextLevel', _NextLevel2.default, false);
...
var _ship = __webpack_require__(/*! ../sprites/ship */ 340);

var _ship2 = _interopRequireDefault(_ship);

var _enemy = __webpack_require__(/*! ./enemy */ 342);
...
var _turret = __webpack_require__(/*! ../sprites/turret */ 341);
...
var _class = function (_Phaser$Sprite) {
  ...
  function _class(_ref) {
    ...
    _this.body.drag.set(300);
    _this.body.maxVelocity.set(200);
    _this.body.immovable = false;

    _this.turret = new _turret2.default({
      game: _this.game,
      x: 10,
      asset: 'turret'
    });
    ...
    //  Our ships bullets
    _this.weapon = game.add.weapon(40, 'ball');
    //  The bullets will be automatically killed when they are 2000ms old
    _this.weapon.bulletKillType = _phaser2.default.Weapon.KILL_LIFESPAN;
    _this.weapon.bulletLifespan = 2000;
    _this.weapon.fireRate = 10; // One bullet every one second

    //  The speed at which the bullet is fired
    _this.weapon.bulletSpeed = 600;
    _this.weapon.trackSprite(_this.turret, 0, 0, true);
    //this.weapon.bulletCollideWorldBounds = true;

    _this.weapon.bullets.setAll('body.bounce.x', 1);
    _this.weapon.bullets.setAll('body.bounce.y', 1);

    _this.addChild(_this.turret);

    _this.chain = game.add.tileSprite(_this.centerX, 12 * 4, 8, game.height - 18 * 4, 'chain');
    _this.chain.anchor.setTo(0.5, 0);
  ...
  _createClass(_class, [{
    key: 'doDamage',
    value: function doDamage(damage) {
      this.hp -= damage;
    }
  }, {
    key: 'fire',
    ...
    value: function update() {
      ...
      if (game.input.keyboard.isDown(_phaser2.default.Keyboard.UP)) {
        this.body.velocity.y = -100;
        this.chain.tilePosition.y = this.body.y;
      }
      if (game.input.keyboard.isDown(_phaser2.default.Keyboard.DOWN)) {
        this.body.velocity.y = 100;
        this.chain.tilePosition.y = this.body.y;
      }
      ...
      if (game.input.keyboard.isDown(_phaser2.default.Keyboard.LEFT)) {
        if (this.turret.angle < -80) this.turret.angle = -80;else this.turret.angle -= 0.5;
      }

      if (game.input.keyboard.isDown(_phaser2.default.Keyboard.RIGHT)) {
        if (this.turret.angle > 80) this.turret.angle = 80;else this.turret.angle += 0.5;
      }
    }
  }]);
...
var Enemy = function () {
    ...
    _createClass(Enemy, [{
        ...
        key: 'setupEnemy',
        value: function setupEnemy(enemy) {
            enemy.anchor.x = 0.5;
            enemy.anchor.y = 0.5;
            enemy.animations.add('kaboom');
        }
    }, {
        key: 'sendAnotherEnemy',
        value: function sendAnotherEnemy() {
            this.launch();
